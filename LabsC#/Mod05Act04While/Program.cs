    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while(i <= numeroEmpleados)//ciclo que permite que se calcule el sueldo bruto y neto de 3 empleados con un descuento de %7
            {
                ...
                pagoHora[i - 1] = float.Parse(Console.ReadLine());//captura de valores para cada empleado utilizando [i - 1]

                Console.Write("Ingrese las horas trabajadas del empleado #" +i+ ": ");//entrada de valores
                horasTrabajadas[i - 1] = float.Parse(Console.ReadLine());//captura de valores para cada empleado utilizando [i - 1]
